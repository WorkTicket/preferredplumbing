  ...
  'septic-systems': {
    ...
    subServices: [
      ...
      },
      {
        ...
        description: 'If your drain field is saturated or not percolating, we rebuild it to code with the right aggregate, layout, and slope for your property.',
      },
      {
...
export const pageMeta: Record<string, { title: string; h1: string }> = {
  ...
  remodels: {
    title: 'Plumbing Remodel Contractor Spirit Lake ID',
    h1: 'Plumbing Remodels & Upgrades in Spirit Lake',
  },
  'bathtubs-showers': {
    title: 'Bathtub Shower Installation Spirit Lake ID',
    h1: 'Bathtubs & Showers in Spirit Lake, Idaho',
  },
  'toilets-faucets': {
    title: 'Toilet Faucet Installation Spirit Lake ID',
    h1: 'Toilet & Faucet Services in Spirit Lake, Idaho',
  },
  dishwashers: {
    title: 'Dishwasher Disposal Installation Spirit Lake ID',
    h1: 'Dishwasher & Disposal Services in Spirit Lake, Idaho',
  },
  'kitchen-remodels': {
    title: 'Kitchen Remodel Plumbing Spirit Lake ID',
    h1: 'Kitchen Remodels in Spirit Lake, Idaho',
  },
  'bathroom-remodels': {
    title: 'Bathroom Remodel Plumbing Spirit Lake ID',
