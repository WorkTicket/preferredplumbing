...
export const galleryProjects: GalleryProject[] = [
  ...
  },
  {
    ...
    category: 'Remodels',
    location: 'Coeur d\'Alene, ID',
    description: 'Complete bathroom remodeling project including moving fixtures, updating supply lines, and installing a new walk-in shower.',
    scopeOfWork: 'Demolition of existing fixtures, re-routing of supply and waste lines, shower valve installation, toilet rough-in, and new fixture trim-out.',
    materials: ['Kohler walk-in shower', 'Toto toilet', 'Delta faucets', 'PEX supply lines', 'PVC DWV'],
    images: [
  ...
  },
  {
    ...
    category: 'Residential',
    location: 'Sandpoint, ID',
    description: 'Premium shower and clawfoot tub installation with antique-style fixtures for a historic home renovation.',
    scopeOfWork: 'Shower base setup, valve installation, clawfoot tub plumbing, faucet and shower head installation, drain assembly, and water testing.',
    materials: ['Clawfoot tub', 'Shower base', 'Antique bronze fixtures', 'Cross-handle faucets', 'Exposed drain kit'],
    images: [
  ...
  },
  {
    ...
    category: 'Commercial',
    location: 'Hayden, ID',
    description: 'Equipment mobilization and site preparation for a major commercial plumbing project.',
    scopeOfWork: 'Site access setup, equipment transport, excavation coordination, and material staging.',
    materials: ['Excavation equipment', 'Heavy-duty piping', 'Site safety equipment'],
    images: [
  ...
  },
  {
    ...
    category: 'Residential',
    location: 'Post Falls, ID',
    description: 'Complete laundry room plumbing including washer box installation, utility sink, and dryer vent hookup.',
    scopeOfWork: 'Washer outlet box installation, hot and cold supply lines, standpipe drain, and utility sink connection.',
    materials: ['Washer outlet box', 'Supply lines', 'Standpipe', 'Utility sink', 'Drain kit'],
    images: [
