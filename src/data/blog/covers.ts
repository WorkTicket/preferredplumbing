...
export const blogCovers: Record<string, { coverImage: string; coverImageAlt: string }> = {
  ...
  'water-softeners-idaho-panhandle': {
    ...
    coverImageAlt:
      'Wooden dock on a clear Idaho Panhandle lake with evergreen forest reflected in still water',
  },
  'burst-pipe-winter-idaho-what-to-do': {
    coverImage: '/images/blog/burst-pipe-winter-idaho-what-to-do.webp',
    coverImageAlt:
      'Burst copper pipe spraying water onto a basement floor, the kind of rupture homeowners face after a hard freeze',
  },
